...
public class DersEklemeGUI extends JFrame {
    ...
    public DersEklemeGUI() {
        ...
        // GUI bileşenlerini ayarlıyoruz
        setTitle("Ders Ekleme ve Silme");
        setSize(600, 400);
        setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);

        // Bölüm ve Sınıf ComboBox'larını oluşturuyoruz
        ...
        // JTable için model oluşturuyoruz
        ...
        // Layout ve bileşenlerin yerleştirilmesi
        ...
        // Bölüm ve sınıf bilgilerini veritabanından alıyoruz
        loadDepartments();
        loadClasses();

        // Ders ekleme butonunun action listener'ı
        addButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                // Veritabanına ders ekliyoruz
                addCourseToDatabase(department_id, class_level_id, name);
            }
        });

        // Ders silme butonunun action listener'ı
        ...
        // Kurs tablosunu veritabanından dolduruyoruz
        loadCourses();
    }
    ...
    private void loadDepartments() {
        try {
            ...
            // JComboBox'a bölümleri ekliyoruz
    ...
    private void loadClasses() {
        try {
            String query = "SELECT * FROM sınıflar"; // Tablo adı 'sınıflar' olarak güncellendi
            Statement statement = connection.createStatement();
            ResultSet resultSet = statement.executeQuery(query);

            // JComboBox'a sınıfları ekliyoruz
            while (resultSet.next()) {
    ...
    private void loadCourses() {
        try {
            ...
            // Tabloyu veritabanı verileriyle doldur
            while (resultSet.next()) {
    ...
    public static void main(String[] args) {
        // DersEklemeGUI'yi göster
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new DersEklemeGUI().setVisible(true); // DersEklemeGUI penceresini aç
            }
        });
    }
}

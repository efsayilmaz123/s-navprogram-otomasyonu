...
public class SinavEklemeGUI extends JFrame {
    ...
    public SinavEklemeGUI() {
        ...
        setSize(488, 339);  // Pencere boyutu
        setLocationRelativeTo(null);  // Pencereyi ekrana ortala

        wrapper = new JPanel();
        wrapper.setBackground(Color.WHITE);
        wrapper.setBounds(400,400,400,400);
        wrapper.setLayout(new GridBagLayout()); // GridBagLayout ile bileşenleri düzenli yerleştiriyoruz
        ...
        gbc_1 = new GridBagConstraints();  // Yeni bir GridBagConstraints nesnesi oluştur
        ...
        // Öğrenci Sayısı
        gbc_5 = new GridBagConstraints();  // Yeni bir GridBagConstraints nesnesi oluştur
